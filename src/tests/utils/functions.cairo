...
use starkfinance::token::erc20::ERC20::Transfer;
use starkfinance::token::erc20::ERC20::Approval;
use starkfinance::interfaces::erc20::ERC20ABIDispatcher;
use starkfinance::tests::utils::constants::{OWNER, ADDRESS_ZERO};
...
fn with_decimals(amount: u128) -> u256 {
    u256 { low: amount * pow::pow(10, 18), high: 0 }
}
