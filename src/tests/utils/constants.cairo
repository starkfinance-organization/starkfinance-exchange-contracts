...
use starkfinance::pair::StarkFinancePair;
use starkfinance::pair_fee_vault::FeesVault;
use option::OptionTrait;
use traits::TryInto;
use starkfinance::utils::{pow};

fn TOTAL_SUPPLY(total: u128) -> u256 {
    u256 { low: total * pow::pow(10, 18), high: 0,  }
}

fn PAIR_CLASS_HASH() -> ClassHash {
    StarkFinancePair::TEST_CLASS_HASH.try_into().unwrap()
}
