...
#[starknet::interface]
trait IStarkFinancePair<TContractState> {
...
#[starknet::interface]
trait IStarkFinancePairCamelOnly<TContractState> {
...
#[starknet::interface]
trait IStarkFinancePairABI<TContractState> {
    fn name(self: @TContractState) -> felt252;
    fn symbol(self: @TContractState) -> felt252;
    fn decimals(self: @TContractState) -> u8;
    fn total_supply(self: @TContractState) -> u256;
...
#[starknet::interface]
trait IStarkFinancePairCamelABI<TContractState> {
    fn name(self: @TContractState) -> felt252;
    fn symbol(self: @TContractState) -> felt252;
    fn decimals(self: @TContractState) -> u8;
    fn totalSupply(self: @TContractState) -> u256;
...
#[starknet::interface]
trait IStarkFinanceCallee<TContractState> {
    fn hook(
        ref self: TContractState,
