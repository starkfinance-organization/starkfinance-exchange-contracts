...
#[starknet::contract]
mod FeesVault {
    use starkfinance::interfaces::factory::{IStarkFinanceFactoryDispatcherTrait, IStarkFinanceFactoryDispatcher};
    use starkfinance::interfaces::erc20::{ERC20ABIDispatcherTrait, ERC20ABIDispatcher};
    use starkfinance::interfaces::pair::IFeesVault;
    ...
    impl FeesVaultImpl of IFeesVault<ContractState> {
        ...
        fn claim_protocol_fees(ref self: ContractState) {
            let factory = IStarkFinanceFactoryDispatcher { contract_address: self.factory.read() };
