/// @title StarkFinanceefi Factory Contract
/// @author StarkFinanceefi Labs
/// @license MIT
/// @dev StarkFinanceefi Pair Factory, responsible for creating pairs and setting fees
...
mod StarkFinanceFactory {
    ...
    use starkfinance::interfaces::factory::{IStarkFinanceFactory};
    ...
    #[external(v0)]
    impl StarkFinanceFactoryImpl of IStarkFinanceFactory<ContractState> {
